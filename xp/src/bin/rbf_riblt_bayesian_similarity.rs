...
use xp::rateless_bloom::bayesian_similarity::BayesianSimilarityFactory;
use xp::run_test;
...
fn main() {
    ...
    let stopping_strategy_factory = BayesianSimilarityFactory::new(optimal_m_ratio, args.target_similarity);
